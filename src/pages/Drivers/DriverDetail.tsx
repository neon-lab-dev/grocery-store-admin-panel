                    ...
                    <form method="dialog"  >
                        <div className="flex flex-col gap-6 justify-center">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="">
                                    <h1 className="font-medium text-[28px] text-accent-700">Driver Details</h1>
                            ...
                            <div className="flex  items-center justify-between gap-[26px]">
                                <div className="flex flex-col justify-center w-[688px] gap-[6px]">
                                    <span className="text-base font-medium text-accent-500 " >Full Name</span>
                                    <h1 className="text-xl font-semibold  text-accent-700">{filteredDriver?.name}</h1>
                                </div>
                                <div className="flex flex-col justify-center w-[688px] gap-[6px]">
                                    <span className="text-base font-medium text-accent-500 " >Mobile No.</span>
                                    <h1 className="text-xl font-semibold  text-accent-700">{filteredDriver?.phone}</h1>
                                </div>
                            </div>
                            <hr className="h-[1px] bg-accent-200" />
                            <div className="">
                                <span className="text-accent-500 text-base font-medium ">Address</span>
                                <p className="text-[17px] leading-normal font-medium text-accent-700 ">Lorem ipsum dolor sit amet consectetur. Neque lacus phasellus egestas rhoncus sit sed dictumst consequat accumsan.</p>
                            </div>
                            <hr className="h-[1px] bg-accent-200" />
                            <div className="flex  items-center justify-between gap-[26px]">
                                <div className="flex flex-col justify-center w-[688px] gap-[6px]">
                                    <span className="text-base font-medium text-accent-500 " >Vehicle Model</span>
                                    <h1 className="text-[20px] font-semibold  text-accent-700">Jawa 42 Bobber   </h1>
                                </div>
                                <div className="flex flex-col justify-center w-[688px] gap-[6px]">
                                    <span className="text-base font-medium text-accent-500 " >Vehicle Number</span>
                                    <h1 className="text-[20px] font-semibold  text-accent-700">{filteredDriver?.vehicle}</h1>
                                </div>
                            </div>
                            <hr className="h-[1px] bg-accent-200" />
                            <div className="flex flex-col justify-center gap-[6px]">
                                <span className="text-accent-500 text-base font-medium ">Proof ID</span>
                            ...
                            <div className="flex items-center justify-between ">
                                <Button variant="error-outline" className="gap-2 flex justify-center  items-center bg-white">
