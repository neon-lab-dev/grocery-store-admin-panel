            ...
            <form method="dialog" className="modal-box min-w-[800px] p-6 rounded-[20px]">
                <div className="">
                    ...
                    <div className="flex justify-between items-center">
                        <div className="">
                            <h1 className='text-xl font-semibold  text-accent-700'>Add Category</h1>
                    ...
                    <div className="mt-[26px] flex items-center justify-center gap-8 w-full">
                        ...
                        <div className="flex flex-col w-full gap-[26px]">
                            <div className="flex flex-col gap-[6px]">
                                <label className='text-base font-medium  text-accent-500' htmlFor="">Enter Category Name</label>
                                <input
